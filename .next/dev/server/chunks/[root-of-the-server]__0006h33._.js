...
/** Request headers we never forward upstream. */ const STRIP_REQUEST_HEADERS = new Set([
    "host",
    "connection",
    "cookie",
    "content-length",
...
/** Response headers we never copy back to the browser. */ const STRIP_RESPONSE_HEADERS = new Set([
    "content-encoding",
    "content-length",
    "transfer-encoding",
    "connection",
...
function badGateway(err) {
    const message = err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"] ? err.message : "The API is unreachable right now. Please try again shortly.";
    const status = err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"] && err.status >= 400 ? err.status : 502;
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        detail: message,
...
function buildUpstreamPath(segments, search) {
...
function forwardRequestHeaders(req, access) {
...
async function handle(req, ctx) {
    ...
    if (!path || path.length === 0) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            detail: "No API path given."
        }, {
            status: 400
        });
    }
    let access = req.cookies.get(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ACCESS_COOKIE"])?.value ?? null;
    const refresh = req.cookies.get(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["REFRESH_COOKIE"])?.value ?? null;
    if (!access && !refresh) {
    ...
    const target = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tokens$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["upstreamUrl"])(buildUpstreamPath(path, req.nextUrl.search));
    let rotated = null;
    // Proactive refresh when the access token is missing or already expired.
    if ((!access || (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tokens$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isJwtExpired"])(access)) && refresh) {
        try {
            const next = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tokens$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["refreshTokens"])(refresh);
            access = next.access;
            rotated = {
                access: next.access,
            ...
            const res = unauthorized("Your session has expired. Please sign in again.", "token_not_valid");
            ...
            return err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"] && err.status >= 500 ? badGateway(err) : res;
        }
    }
    if (!access) return unauthorized("Authentication credentials were not provided.");
    const doFetch = (token)=>fetch(target, {
            method,
    ...
    if (rotated && (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tokens$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["decodeJwt"])(rotated.access)) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tokens$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["writeTokensOnResponse"])(res, rotated);
    }
    return res;
}
const GET = handle;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0006h33._.js.map