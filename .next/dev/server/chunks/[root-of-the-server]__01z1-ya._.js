...
function claimsToUser(access) {
    const claims = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tokens$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["decodeJwt"])(access);
...
async function GET() {
    const { access, refresh } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tokens$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readTokens"])();
    if (access && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tokens$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isJwtExpired"])(access)) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            authenticated: true,
            user: claimsToUser(access)
        });
    }
    if (refresh) {
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tokens$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["writeTokensOnResponse"])(res, {
                access: next.access,
                refresh: next.refresh
            });
            return res;
        } catch (err) {
            const status = err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"] && err.status >= 500 ? 502 : 200;
            const res = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                authenticated: false,
                user: null
            }, {
            ...
            res.cookies.set("dcc_access", "", {
                path: "/",
                maxAge: 0
            });
            res.cookies.set("dcc_refresh", "", {
                path: "/",
                maxAge: 0
            });
            return res;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__01z1-ya._.js.map